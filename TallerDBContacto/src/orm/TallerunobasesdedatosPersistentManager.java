...
public class TallerunobasesdedatosPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Tallerunobasesdedatos";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TallerunobasesdedatosPersistentManager();
		}
